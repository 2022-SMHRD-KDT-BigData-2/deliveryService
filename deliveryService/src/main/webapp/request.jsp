		...
		<div class="popup">
			...
			<div class="content">
				<fieldset class="fie1" align="center">
					<label class="legend"><b>심부름 항목 선택</b> </label> <select
						name="errand"
					...
					<div data-role="fieldcontain">
						<label class="legend"><b>심부름 요청 내용</b> </label> <input
							type="image" name="file" value="사진첨부"> <br> <input
							type="text" name="content" placeholder="요청 내용을 상세하게 입력해 주세요."
				...
				<div data-role="footer" data-position="fixed" align="center">
					...
					<a href="goBoardMain" class="button next">취소</a>
